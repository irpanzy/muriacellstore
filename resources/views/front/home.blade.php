    ...
    <div class="relative flex flex-col w-full max-w-[640px] min-h-screen gap-5 mx-auto bg-[#F5F5F0]">
        ...
        <section id="featured" class="flex flex-col gap-4">
            ...
            <div class="swiper w-full overflow-hidden">
                <div class="swiper-wrapper">
                    @forelse ($popularHandphones as $itemPopularHandphone)
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col gap-[14px] justify-between">
                                        <div class="flex items-center justify-between gap-4">
                                            <h3 class="font-bold leading-[20px]">{{ $itemPopularHandphone->name }}
                                            </h3>
                                            <p class="font-bold text-sm leading-[21px] text-nowrap">
                                                Rp {{ number_format($itemPopularHandphone->price, 0, ',', '.') }}
                                            </p>
                                        </div>
        ...
        <section id="fresh" class="flex flex-col gap-4 px-4">
            ...
            <div class="flex flex-col gap-4">
                @forelse ($newHandphones as $itemNewHandphone)
                        ...
                        <div
                            ...
                            <div class="flex w-full items-center justify-between gap-[14px]">
                                <div class="flex flex-col gap-[6px]">
                                    <h3 class="font-bold leading-[20px]">{{ $itemNewHandphone->name }}</h3>
                                    <p class="text-sm leading-[21px] text-[#878785]">
                                        {{ $itemNewHandphone->category->name }}</p>
                                </div>
        ...
        <div id="bottom-nav" class="relative flex h-[90px] w-full shrink-0">
