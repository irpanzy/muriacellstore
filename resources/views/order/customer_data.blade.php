...
<body>
    <div class="relative flex flex-col w-full max-w-[640px] min-h-screen gap-5 mx-auto bg-[#F5F5F0]">
        <div id="top-bar" class="flex justify-between items-center px-4 mt-[20px]">
            <a href="{{ route('front.booking', $handphone->slug) }} ">
                <img src="{{ asset('assets/images/icons/back.svg') }}" class="w-10 h-10" alt="icon">
            </a>
            <p class="font-bold text-2xl leading-[27px]">Delivery</p>
        ...
        <div class="flex items-center rounded-3xl gap-[14px] p-[10px_16px_16px_10px] bg-white mx-4">
            ...
            <div class="flex flex-col w-full">
                <h1 id="title" class="font-bold text-lg leading-6">{{ $handphone->name }}</h1>
                <p class="font-semibold text-sm leading-[21px]">{{ $orderData['handphone_capacity'] }} •
