...
Route::get('/details/{handphone:slug}', [FrontController::class, 'details'])->name('front.details');

Route::post('/order/begin/{handphone:slug}', [OrderController::class, 'saveOrder'])->name('front.save_order');
